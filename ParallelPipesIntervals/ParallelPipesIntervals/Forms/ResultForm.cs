...
namespace ParallelPipesIntervals
{
    public partial class ResultForm : Form
    {
        ...
        public ResultForm(CP cp) : this()
        {
            ...
            CalcTimeText.Text = "Загружено из файла";
            InitComboBoxes();
        }
        ...
        public ResultForm()
        {
            ...
            {
                graphicBtn_Click("Защитный потенциал,Upr, В", "Upr", cp.name, comboBoxUpr, cp.getUtpr);
            };
        ...
        private void saveResultsToFile(Func<int, double[][]> points, string pointsName)
        {
            SaveFileDialog saveFileDialog = new SaveFileDialog()
            {
                ...
                FilterIndex = 0,
                FileName = (string.Format(pointsName, "") + cp.name).Replace(" ", "")
            };
